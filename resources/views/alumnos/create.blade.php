...
<body>
    <div class="container" align='center'>
        <h3>Alumnos - Create!</h3>
        <form name="" method="post" action="{{route('alumnos.store')}}">
            <!--- proteccion de ataques malicionsos -->
            @csrf
            ...
            F-Nacimiento: <input type="date" name="fnacimiento" value="{{ old('fnacimiento') }}"/>
            <span style="color:red">
                @error('fnacimiento')
                    {{ $message }}
                @enderror
            ...
            Telefono: <input type="number" name="telefono" value="{{ old('telefono') }}"/>
            <span style="color:red">
                @error('telefono')
                    {{ $message }}
                @enderror
